...
const UserLayout = () => {
    ...
    const menuItems = [
        { name: 'Ma profile', path: '/profile', icon: <LayoutDashboard size={20} /> },
        { name: 'Mes Bulletins', path: '/bulletins', icon: <FileText size={20} /> }, // Profile and Dashboard can be same for now or separate
        { name: 'Réclamations', path: '/reclamations', icon: <AlertTriangle size={20} /> },
    ];
        ...
        <div>
          <div className="p-6 flex items-center gap-3 border-b border-slate-100 dark:border-white/10">
            ...
            <div className="flex flex-col">
                ...
                <span className="text-[10px] font-bold text-blue-600 dark:text-blue-400 tracking-widest uppercase mt-1">Espace Adhérent</span>
            </div>
          </div>
        ...
        <header className="h-20 bg-white dark:bg-slate-900 border-b border-gray-200 dark:border-slate-800 flex items-center justify-end px-8 shadow-sm gap-4 transition-colors duration-300">
            ...
            <div className="flex items-center gap-4 cursor-pointer hover:bg-gray-100 dark:hover:bg-slate-800 p-2 rounded-2xl transition-all">
                ...
                <div className="flex flex-col">
                    ...
                    <span className="text-[10px] uppercase font-black text-slate-400 dark:text-slate-500 tracking-widest mt-1">Status: Adhérent</span>
                </div>
            </div>
        </header>
