                                        ...
                                        <td className="px-10 py-7">
                                            <div className="flex justify-center gap-3">
                                                <button
                                                    ...
                                                    className="p-3 bg-red-50 text-red-600 rounded-2xl hover:bg-red-600 hover:text-white opacity-0 group-hover:opacity-100 transition-all disabled:opacity-30 disabled:cursor-not-allowed"
                                                    title={isAssignedToOther ? `Assigné à ${r.admin?.prenom} ${r.admin?.nom}` : 'Supprimer'}
