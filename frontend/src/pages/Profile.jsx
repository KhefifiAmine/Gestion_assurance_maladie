...
const Profile = () => {
  ...
  const validate = () => {
    ...
    if (!form.adresse || form.adresse.trim().length >10) newErrs.adresse = 'Maximum 10 caractères';
  ...
  return (
    <div className="prof-page-bg">
      <div className="prof-main-card" style={{ position: 'relative' }}>
          ...
          {activeTab === 'adhesion' && (
            <div className="adhesion-section">
              ...
              <div className="det-grid">
                <DetailCard icon={User} label="Nom" value={user.nom} color="blue" name="nom" editable isEditingDet={isEditingDet} form={form} setForm={setForm} errors={errors} setErrors={setErrors} />
                <DetailCard icon={User} label="Prénom" value={user.prenom} color="blue" name="prenom" editable isEditingDet={isEditingDet} form={form} setForm={setForm} errors={errors} setErrors={setErrors} />
                <DetailCard icon={Calendar} label="Date de naissance" value={user.ddn} color="blue" name="ddn" type="date" editable isEditingDet={isEditingDet} form={form} setForm={setForm} errors={errors} setErrors={setErrors} />
                <DetailCard icon={Phone} label="Téléphone" value={user.telephone} color="rose" name="telephone" editable isEditingDet={isEditingDet} form={form} setForm={setForm} errors={errors} setErrors={setErrors} />
                <DetailCard icon={Home} label="Ville" value={user.ville} color="green" name="ville" editable isEditingDet={isEditingDet} form={form} setForm={setForm} errors={errors} setErrors={setErrors} />
                <DetailCard icon={MapPin} label="Adresse" value={user.adresse} color="green" name="adresse" editable isEditingDet={isEditingDet} form={form} setForm={setForm} errors={errors} setErrors={setErrors} />

                <DetailCard icon={Hash} label="Matricule" value={user.matricule} readOnlyValuePlaceholder="—" />
                <DetailCard icon={Mail} label="Email" value={user.email} readOnlyValuePlaceholder="—" />
                <DetailCard icon={Calendar} label="Date d'adhésion" value={user.createdAt} type="date" readOnlyValuePlaceholder="—" />
              </div>
            </div>
          )}
                ...
                {isChangingPwd ? (
                  ...
                  >
                    <div className="form-group" style={{ marginBottom: '15px' }}>
                      <label style={{ display: 'block', fontSize: '14px', marginBottom: '5px', fontWeight: 500, color: theme === 'dark' ? '#94a3b8' : '#475569' }}>Ancien mot de passe</label>
                      <input
                        type="password"
                        ...
                        style={{ 
                          ...
                          border: pwdErrors.ancienMdp ? '1px solid red' : (theme === 'dark' ? '1px solid #334155' : '1px solid #cbd5e1') 
                        }}
                      />
                    ...
                    <div className="form-group" style={{ marginBottom: '15px' }}>
                      <label style={{ display: 'block', fontSize: '14px', marginBottom: '5px', fontWeight: 500, color: theme === 'dark' ? '#94a3b8' : '#475569' }}>Nouveau mot de passe</label>
                      <input
                        type="password"
                        ...
                        style={{ 
                          ...
                          background: theme === 'dark' ? '#0f172a' : 'white',
                          color: theme === 'dark' ? 'white' : 'black',
                          border: pwdErrors.nouveauMdp ? '1px solid red' : (theme === 'dark' ? '1px solid #334155' : '1px solid #cbd5e1') 
                        }}
                      />
                    ...
                    <div className="form-group" style={{ marginBottom: '20px' }}>
                      <label style={{ display: 'block', fontSize: '14px', marginBottom: '5px', fontWeight: 500, color: theme === 'dark' ? '#94a3b8' : '#475569' }}>Confirmer le mot de passe</label>
                      <input
                        type="password"
                        ...
                        style={{ 
                          ...
                          background: theme === 'dark' ? '#0f172a' : 'white',
                          color: theme === 'dark' ? 'white' : 'black',
                          border: pwdErrors.confirmMdp ? '1px solid red' : (theme === 'dark' ? '1px solid #334155' : '1px solid #cbd5e1') 
                        }}
                      />
