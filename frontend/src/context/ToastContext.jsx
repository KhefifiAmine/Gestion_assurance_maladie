...
export const ToastProvider = ({ children }) => {
    ...
    const showToast = useCallback((message, type = 'success', duration = 5000, persistent = true) => {
        const id = Date.now();
        // The user specifically requested both error and success/affirmation to be persistent.
        // We will default them all to persistent to be safe and meet their strict requirement.
