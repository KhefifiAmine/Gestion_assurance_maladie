                    ...
                    >
                        ...
                        <div className="flex-1 flex overflow-hidden min-h-0">
                            ...
                            <div className="flex-1 lg:flex-[3] overflow-y-auto custom-scrollbar p-5 md:p-7 space-y-6">
                                ...
                                {bulletin.statut === 3 && bulletin.motif_rejet && (
                                    <motion.div
                                    ...
                                    >
                                        ...
                                        <div>
                                            <p className="text-[10px] font-black uppercase tracking-[0.2em] text-red-600 mb-1">Motif du rejet</p>
                                            <p className="text-sm font-bold text-red-800 dark:text-red-200 leading-relaxed">
                                                {bulletin.motif_rejet}
                                            </p>
                                        </div>
                                    </motion.div>
                                )}
