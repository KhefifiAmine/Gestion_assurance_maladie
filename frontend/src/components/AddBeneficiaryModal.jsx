                ...
                <div className="flex min-h-full items-center justify-center p-4">
                    ...
                    >
                        ...
                        <div className="flex flex-col lg:flex-row h-full">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-10">
                                    ...
                                    <div className="space-y-6 md:col-span-2">
                                        ...
                                        <div className="relative">
                                            ...
                                            {(documentFiles.length > 0 || (editingBeneficiaryId && documentPreviewUrls.length > 0)) ? (
                                                <div className="space-y-4">
                                                    <div className="grid grid-cols-1 gap-3">
                                                        {documentFiles.map((file, idx) => (
                                                            <motion.div
                                                                ...
                                                                className="group relative overflow-hidden p-4 bg-slate-50 dark:bg-slate-800/50 border border-slate-200 dark:border-slate-700 rounded-2xl transition-all hover:bg-white dark:hover:bg-slate-800 shadow-sm"
                                                            >
                                                                <div className="flex items-center justify-between relative z-10">
                                                                    <div className="flex items-center gap-4 overflow-hidden">
                                                                        <div className="w-10 h-10 rounded-xl bg-purple-100 dark:bg-purple-900/30 flex items-center justify-center text-purple-600 shrink-0">
                                                                            {file.type === 'application/pdf' ? <FileText size={20} /> : <Camera size={20} />}
                                                                        </div>
                                                                    ...
                                                                    <button
                                                                        ...
                                                                        className="p-2 rounded-lg bg-rose-50 dark:bg-rose-900/10 text-rose-500 hover:bg-rose-500 hover:text-white transition-all"
                                                                    >
                                                                        <X size={14} />
                                                                    </button>
                                                                </div>
                                                        ...
                                                        {editingBeneficiaryId && documentFiles.length === 0 && documentPreviewUrls.map((url, idx) => (
                                                            <div key={`old-${idx}`} className="p-4 bg-slate-50 dark:bg-slate-800/50 border border-slate-200 dark:border-slate-700 rounded-2xl flex items-center justify-between">
                                                                <div className="flex items-center gap-4">
                                                                    <div className="w-10 h-10 rounded-xl bg-emerald-100 dark:bg-emerald-900/30 flex items-center justify-center text-emerald-600">
                                                                        <CheckCircle2 size={20} />
                                                                    </div>
                                                                    <p className="text-xs font-black text-slate-500 uppercase tracking-widest">Justificatif existant {idx + 1}</p>
                                                                </div>
                                                    ...
                                                    <button
                                                        ...
                                                        className="w-full py-4 rounded-2xl border-2 border-dashed border-slate-200 dark:border-slate-700 text-slate-400 hover:border-purple-400 hover:text-purple-600 font-black text-[10px] uppercase tracking-widest transition-all"
                                                    >
                            ...
                            {documentPreviewUrls && documentPreviewUrls.length > 0 && (
                                    ...
                                    <div className="relative z-10 flex flex-col h-full overflow-hidden">
                                        <div className="flex items-center gap-3 mb-8">
                                            ...
                                            <div>
                                                ...
                                                <p className="text-[10px] font-bold text-slate-400 uppercase tracking-tight">{documentPreviewUrls.length} document(s) détecté(s)</p>
                                            </div>
                                        </div>
