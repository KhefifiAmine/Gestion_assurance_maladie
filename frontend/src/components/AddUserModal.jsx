                    ...
                    <form onSubmit={handleSubmit} className="p-6 space-y-5" noValidate>
                        ...
                        <div className="space-y-1.5">
                            <label className="text-xs font-black uppercase text-slate-500 tracking-widest flex items-center gap-2">
                                ...
                                <input 
                                    type="text"
                                    className={`w-full px-4 py-3 bg-slate-50 dark:bg-slate-800 border ${errors.matricule ? 'border-red-500' : 'border-slate-100 dark:border-slate-700'} rounded-xl focus:outline-none focus:ring-4 focus:ring-purple-500/10 focus:border-purple-500 transition-all font-bold text-slate-900 dark:text-white`}
