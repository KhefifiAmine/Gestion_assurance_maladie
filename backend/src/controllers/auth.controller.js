...
const register = async (req, res) => {
    try {
        const { nom, matricule, prenom, telephone, ddn, adresse, ville, email } = req.body;
        ...
        // On active le compte immédiatement (Désactivation de la validation admin)
        ...
        const newUser = await User.create({
            ...
            role: 'ADHERENT', 
            statut: 1, // 1 = Actif immédiatement
