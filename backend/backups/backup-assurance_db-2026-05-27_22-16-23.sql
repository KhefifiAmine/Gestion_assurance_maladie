...
-- Generated at: 2026-05-27T22:16:23.262Z
...
CREATE TABLE `acte_medicaux` (
  ...
  CONSTRAINT `acte_medicaux_ibfk_33` FOREIGN KEY (`bulletinId`) REFERENCES `bulletin_soins` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `acte_medicaux_ibfk_34` FOREIGN KEY (`prestataireId`) REFERENCES `prestataires` (`id`) ON DELETE SET NULL ON UPDATE CASCADE
...
CREATE TABLE `pharmacies` (
  ...
  KEY `bulletinId` (`bulletinId`),
  KEY `prestataireId` (`prestataireId`),
  CONSTRAINT `pharmacies_ibfk_33` FOREIGN KEY (`bulletinId`) REFERENCES `bulletin_soins` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `pharmacies_ibfk_34` FOREIGN KEY (`prestataireId`) REFERENCES `prestataires` (`id`) ON DELETE SET NULL ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `reclamation_messages` (
  ...
  CONSTRAINT `reclamation_messages_ibfk_31` FOREIGN KEY (`reclamationId`) REFERENCES `reclamations` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `reclamation_messages_ibfk_32` FOREIGN KEY (`senderId`) REFERENCES `users` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
...
CREATE TABLE `reclamations` (
  ...
  KEY `adminId` (`adminId`),
  KEY `bulletinId` (`bulletinId`),
  CONSTRAINT `reclamations_ibfk_46` FOREIGN KEY (`userId`) REFERENCES `users` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `reclamations_ibfk_47` FOREIGN KEY (`adminId`) REFERENCES `users` (`id`) ON DELETE SET NULL ON UPDATE CASCADE,
  CONSTRAINT `reclamations_ibfk_48` FOREIGN KEY (`bulletinId`) REFERENCES `bulletin_soins` (`id`) ON DELETE SET NULL ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
(1, 'REQ-1779378942035-455', 'AUTRES RECLAMATIONS BS', 'test', 'En cours', 'Moyenne', 1, 4, '2026-05-21 15:55:42', '2026-05-27 22:16:07', 1);
