...
-- Generated at: 2026-05-30T10:15:06.005Z
...
(5, 2, 'test', 'test', 'Conjoint', '2026-05-12', 'M', '[\"1779137060844-419705599.jpg\"]', 'En attente', 'jkuighlumilk', 0, 0, 0, 0, '2026-05-18 20:44:20', '2026-05-18 21:18:24', 'Pièce justificative non conforme ou illisible'),
(6, 3, 'ahmed', 'ahmed', 'Enfant', '2026-05-16', 'M', '[\"1780069809108-788542949.jpg\"]', 'En attente', 'vous devez télécharger une document lisible', 0, 0, 0, 0, '2026-05-29 15:50:09', '2026-05-29 15:53:17', 'Pièce justificative non conforme ou illisible');
...
(55, 'POST sur /api/auth/login', '127.0.0.1', 4, '2026-05-28 11:12:15', '2026-05-28 11:12:15', NULL, NULL, NULL),
(56, 'POST sur /api/auth/login', '127.0.0.1', 2, '2026-05-29 15:29:52', '2026-05-29 15:29:52', NULL, NULL, NULL),
(57, 'POST sur /api/auth/logout', '127.0.0.1', 2, '2026-05-29 15:30:07', '2026-05-29 15:30:07', NULL, NULL, NULL),
(58, 'POST sur /api/auth/logout', '127.0.0.1', 2, '2026-05-29 15:30:07', '2026-05-29 15:30:07', NULL, '{\"userId\":2}', '2026-05-29 15:30:07'),
(59, 'POST sur /api/auth/login', '127.0.0.1', 3, '2026-05-29 15:32:22', '2026-05-29 15:32:22', NULL, NULL, NULL),
(60, 'PUT sur /api/profile', '127.0.0.1', 3, '2026-05-29 15:33:30', '2026-05-29 15:33:30', NULL, '{\"nom\":\"Bassem\",\"prenom\":\"Mathlouthi\",\"adresse\":\"rue klebia\",\"telephone\":\"26557704\",\"ddn\":\"2000-10-18\",\"ville\":\"Klebia\",\"code_cnam\":\"02584120\"}', '2026-05-29 15:33:30'),
(61, 'POST sur /api/beneficiaries', '127.0.0.1', 3, '2026-05-29 15:50:09', '2026-05-29 15:50:09', NULL, '{\"nom\":\"ahmed\",\"prenom\":\"ahmed\",\"relation\":\"Enfant\",\"ddn\":\"2026-05-16\",\"sexe\":\"M\",\"handicape\":\"false\",\"etudiant\":\"false\",\"chomage\":\"false\",\"celibataire\":\"false\"}', '2026-05-29 15:50:09'),
(62, 'POST sur /api/auth/logout', '127.0.0.1', 3, '2026-05-29 15:50:22', '2026-05-29 15:50:22', NULL, NULL, NULL),
(63, 'POST sur /api/auth/logout', '127.0.0.1', 3, '2026-05-29 15:50:22', '2026-05-29 15:50:22', NULL, '{\"userId\":3}', '2026-05-29 15:50:22'),
(64, 'POST sur /api/auth/login', '127.0.0.1', 2, '2026-05-29 15:50:43', '2026-05-29 15:50:43', NULL, NULL, NULL),
(65, 'PUT sur /api/notifications/:id/read', '127.0.0.1', 2, '2026-05-29 15:51:23', '2026-05-29 15:51:23', NULL, NULL, '2026-05-29 15:51:23'),
(66, 'PUT sur /api/notifications/:id/read', '127.0.0.1', 2, '2026-05-29 15:51:24', '2026-05-29 15:51:24', NULL, NULL, '2026-05-29 15:51:24'),
(67, 'PUT sur /api/notifications/:id/read', '127.0.0.1', 2, '2026-05-29 15:51:25', '2026-05-29 15:51:25', NULL, NULL, '2026-05-29 15:51:25'),
(68, 'PUT sur /api/notifications/:id/read', '127.0.0.1', 2, '2026-05-29 15:51:26', '2026-05-29 15:51:26', NULL, NULL, '2026-05-29 15:51:26'),
(69, 'PUT sur /api/beneficiaries/:id/status', '127.0.0.1', 2, '2026-05-29 15:53:17', '2026-05-29 15:53:17', '{\"statut\":\"En attente\",\"objetRefus\":null,\"motifRefus\":null}', '{\"statut\":\"Rejeté\",\"objetRefus\":\"Pièce justificative non conforme ou illisible\",\"motifRefus\":\"vous devez télécharger une document lisible\"}', '2026-05-29 15:53:17'),
(70, 'POST sur /api/auth/logout', '127.0.0.1', 2, '2026-05-29 16:21:59', '2026-05-29 16:21:59', NULL, NULL, NULL),
(71, 'POST sur /api/auth/logout', '127.0.0.1', 2, '2026-05-29 16:21:59', '2026-05-29 16:21:59', NULL, '{\"userId\":2}', '2026-05-29 16:21:59'),
(72, 'POST sur /api/auth/login', '127.0.0.1', 3, '2026-05-29 16:22:31', '2026-05-29 16:22:31', NULL, NULL, NULL),
(73, 'POST sur /api/ai/analyze-bulletin', '127.0.0.1', 3, '2026-05-29 16:45:00', '2026-05-29 16:45:00', NULL, NULL, '2026-05-29 16:45:00'),
(74, 'POST sur /api/ai/analyze-bulletin', '127.0.0.1', 3, '2026-05-29 18:10:04', '2026-05-29 18:10:04', NULL, NULL, '2026-05-29 18:10:04');
...
(1, '👶 Nouveau bénéficiaire à valider', 'Un nouveau bénéficiaire (test test) a été ajouté par RH Responsable.', 'beneficiaire', 'normale', 1, 2, '2026-05-18 20:44:20', '2026-05-29 15:51:26'),
(2, '✅ Bénéficiaire validé', 'Votre demande d\'ajout du bénéficiaire test test a été validée par l\'administration.', 'beneficiaire', 'normale', 1, 2, '2026-05-18 20:44:29', '2026-05-29 15:51:25'),
(3, '❌ Bénéficiaire rejeté', 'Votre demande d\'ajout du bénéficiaire test test a été rejetée. Motif : Informations incohérentes entre les documents fournis — yytfgkjh', 'beneficiaire', 'haute', 1, 2, '2026-05-18 20:58:08', '2026-05-29 15:51:24'),
(4, '❌ Bénéficiaire rejeté', 'Votre demande d\'ajout du bénéficiaire test test a été rejetée. Motif : Pièce justificative non conforme ou illisible — jkuighlumilk', 'beneficiaire', 'haute', 1, 2, '2026-05-18 21:18:24', '2026-05-29 15:51:23'),
...
(14, '👶 Nouveau bénéficiaire à valider', 'Un nouveau bénéficiaire (ahmed ahmed) a été ajouté par Mathlouthi Bassem.', 'beneficiaire', 'normale', 0, 2, '2026-05-29 15:50:09', '2026-05-29 15:50:09'),
(15, '❌ Bénéficiaire rejeté', 'Votre demande d\'ajout du bénéficiaire ahmed ahmed a été rejetée. Motif : Pièce justificative non conforme ou illisible — vous devez télécharger une document lisible', 'beneficiaire', 'haute', 0, 3, '2026-05-29 15:53:17', '2026-05-29 15:53:17');
...
(3, 'ADH001', 'Bassem', 'Mathlouthi', '2000-10-18', '26557704', 'user@test.com', '$2b$10$4BjdVMtaICq06SpXS7GCzOwOiJ7HAuvhR/VoDH.VA7z90kG/vb5km', 1, 'Adresse non valide', NULL, 'rue klebia', 'Klebia', 'M', 'ADHERENT', NULL, NULL, NULL, 0, 0, 0, NULL, '02584120', '2026-05-18 19:45:55', '2026-05-29 15:33:30'),
